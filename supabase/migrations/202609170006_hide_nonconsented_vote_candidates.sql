-- Keep the public vote/scorer feed aligned with the public roster consent.
-- This hides organizer-removed and non-consenting registrations everywhere,
-- and prevents a hidden registration id from being voted for through the RPC.
